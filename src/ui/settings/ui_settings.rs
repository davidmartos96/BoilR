...
use crate::platforms::{egs::EpicPlatform, heroic::HeroicPlatform};

use crate::ui::new_uiapp::NewUiApp;
    ...
    fn render_epic_settings(&mut self, ui: &mut egui::Ui) {
        ...
        .show(ui, |ui| {
            ...
            let manifests =self.epic_manifests.get_or_insert_with(||{
                ...
                let manifests = crate::platforms::Platform::get_shortcuts(&epic_platform);
